...
# chọn yccđ
###############################################################################################################################
vote_option = ['Sử dụng được hoặc chỉ cần điều chỉnh một ít','Có ý dùng được nhưng cần điều chỉnh nhiều', 'Không sử dụng được','Không liên quan', 'Không hiểu', 'Trùng ý tưởng phía trước']
...
prompt = f'''
    ...
    Gợi ý cho tôi 5 ý tưởng dự án sáng chế một món đồ nào đó mà qua đó học sinh có thể {yccd}.
...
with st.form('Đánh giá'):
    ...
    if vote_option.index(evaluate1) < 3:
        ...
        newRow1 = [khoi, mon, chuDe, diemKienThuc, yccd, st.session_state.res_splited[0]] + x1
    else:
        newRow1 = []
    ...
    if vote_option.index(evaluate2) < 3:
        ...
        newRow2 = [khoi, mon, chuDe, diemKienThuc, yccd, st.session_state.res_splited[1]] + x2
    else:
        newRow2 = []
    ...
    if vote_option.index(evaluate3) < 3:
        ...
        newRow3 = [khoi, mon, chuDe, diemKienThuc, yccd, st.session_state.res_splited[2]] + x3
    else:
        newRow3 = []
    ...
    if vote_option.index(evaluate4) < 3:
        ...
        newRow4 = [khoi, mon, chuDe, diemKienThuc, yccd, st.session_state.res_splited[3]] + x4
    else:
        newRow4 = []
    ...
    if vote_option.index(evaluate5) < 3:
        ...
        newRow5 = [khoi, mon, chuDe, diemKienThuc, yccd, st.session_state.res_splited[4]] + x5
    else:
        newRow5 = []
