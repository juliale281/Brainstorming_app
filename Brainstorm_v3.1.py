# done
# cho phép chọn 1 khối-môn, nhiều yccd
###############################################################################################################################
#Import library
###############################################################################################################################
...
with st.form('Đánh giá'):
    ...
    if vote_option.index(evaluate1) < 4:
    ...
    if vote_option.index(evaluate2) < 4:
    ...
    if vote_option.index(evaluate3) < 4:
    ...
    if vote_option.index(evaluate4) < 4:
    ...
    if vote_option.index(evaluate5) < 4:
